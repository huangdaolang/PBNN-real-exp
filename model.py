...
class PrefNet(nn.Module):
    def __init__(self, n_input):
        ...
        self.fc4 = bnn.BayesLinear(prior_mu=0, prior_sigma=0.1, in_features=15, out_features=1)
        self.fc5 = bnn.BayesLinear(prior_mu=0, prior_sigma=0.1, in_features=15, out_features=1)
